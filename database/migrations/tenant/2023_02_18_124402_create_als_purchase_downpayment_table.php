...
class CreateAlsPurchaseDownpaymentTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('als_purchase_downpayment', function (Blueprint $table) {
            $table->id();
            ...
            $table->longText('tax_group')->nullable();
    ...
    {
        Schema::dropIfExists('als_purchase_downpayment');
    }
}
