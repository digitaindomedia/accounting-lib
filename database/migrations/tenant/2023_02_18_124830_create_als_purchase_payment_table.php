...
class CreateAlsPurchasePaymentTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('als_purchase_payment', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('als_purchase_payment');
    }
}
