...
Route::group([
    ...
    Route::prefix('report')->group(function () {
        ...
        Route::get('kas-accounts', [BukuBesarController::class, 'getKasAccounts']);
        Route::get('kas', [BukuBesarController::class, 'showKas']);
        Route::get('export-excel-kas', [BukuBesarController::class, 'exportKas']);
        Route::get('export-pdf-kas', [BukuBesarController::class, 'exportKasToPdf']);
        Route::get('bank', [BukuBesarController::class, 'showBank']);
        Route::get('export-excel-bank', [BukuBesarController::class, 'exportBank']);
        Route::get('export-pdf-bank', [BukuBesarController::class, 'exportBankToPdf']);
        Route::get('detail-kas', [BukuBesarController::class, 'showDetailKas']);
        Route::get('export-excel-detail-kas', [BukuBesarController::class, 'exportDetailKas']);
        Route::get('export-pdf-detail-kas', [BukuBesarController::class, 'exportDetailKasToPdf']);
        Route::get('detail-bank', [BukuBesarController::class, 'showDetailBank']);
        Route::get('export-excel-detail-bank', [BukuBesarController::class, 'exportDetailBank']);
        Route::get('export-pdf-detail-bank', [BukuBesarController::class, 'exportDetailBankToPdf']);
