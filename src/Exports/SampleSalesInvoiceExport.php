...
class SampleSalesInvoiceExport implements FromArray, WithHeadings
{
    protected $orderType;
    ...
    public function array(): array
    {
        ...
        if($this->orderType == ProductType::ITEM){
            ...
            return [
                ...
                ['PO001', '2024-07-01', "A00003" ,"keterangan order penjualan", 0, "fix", "exclude", "J002", 200, 2000000, 0, "fix",0],
            ];
        }
