...
class CreateBomRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'items.*.material_source_type' => ['nullable', 'in:product,category'],
            'items.*.product_id' => ['nullable'],
            'items.*.source_product_id' => ['nullable'],
            'items.*.category_id' => ['nullable'],
            'items.*.source_category_id' => ['nullable'],
    ...
    public function messages()
    {
        return [
            ...
            'items.*.material_source_type.in' => 'Tipe bahan pada salah satu item tidak valid.',
