...
class CreatePurchaseReturRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        $table = (new PurchaseRetur())->getTable();
        $prefix = SettingRepo::getOptionValue(KeyNomor::NO_RETUR_PEMBELIAN);
        $rules = PurchaseRetur::$rules;
        if (empty($prefix)) {
            $rules['retur_no'] = [
                'required',
